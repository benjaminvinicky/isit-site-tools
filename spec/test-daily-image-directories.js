...
describe('Create directories for each day we took photos', function() {
    ...
    const elfConfig = require('isit-code-vinicky').elfConfig;
    const elfLog = require('isit-code-vinicky').elfLog('test-daily-image-directories');
    ...
    /*fit('to find unique file name preface', function(done) {
        const testImages = configurationSettings.getSelectedElvenImage('testImages');
